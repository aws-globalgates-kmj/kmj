...
이전 프로젝트보다 훨씬 다양한 기술을 직접 경험할 수 있어 좋았습니다. FASTAPI 를 통한 AI 연동, Quartz 스케줄러, 부트페이 결제 등 새로운 기술을
적용하고 배포까지 다뤄보면서, 단순히 코드만 작성하는 것을 넘어 서비스가 실제로 어떻게 동작하고 운영되는지 전체적인
흐름을 이해할 수 있었습니다. 시야가 한 단계 넓어진 경험이었습니다.
